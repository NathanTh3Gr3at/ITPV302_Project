...
class VeganTabView extends StatefulWidget {

  const VeganTabView({super.key});

  @override
  State<VeganTabView> createState() => _VeganTabViewState();
}

class _VeganTabViewState extends State<VeganTabView> {
