...
class VegetarianTabView extends StatefulWidget {

  const VegetarianTabView({super.key});

  @override
  State<VegetarianTabView> createState() => _VegetarianTabViewState();
}

class _VegetarianTabViewState extends State<VegetarianTabView> {
  ...
  var isLiked = false;
    return StreamBuilder(
      ...
      stream: _recipeStorage.getVegetarianRecipes(),
