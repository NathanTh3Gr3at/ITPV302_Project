...
class PaleoTabView extends StatefulWidget {

  const PaleoTabView({super.key});

  @override
  State<PaleoTabView> createState() => _PaleoTabViewState();
}

class _PaleoTabViewState extends State<PaleoTabView> {
  ...
  var isLiked = false;
    return StreamBuilder(
      ...
      stream: _recipeStorage.getPaleoRecipes(),
