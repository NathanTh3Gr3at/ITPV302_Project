...
class PescatarianTabView extends StatefulWidget {

  const PescatarianTabView({super.key});

  @override
  State<PescatarianTabView> createState() => _PescatarianTabViewState();
}

class _PescatarianTabViewState extends State<PescatarianTabView> {
  ...
  var isLiked = false;
    return StreamBuilder(
      ...
      stream: _recipeStorage.getPescatarianRecipes(),
