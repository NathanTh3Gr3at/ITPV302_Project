...
class LowSodiumTabView extends StatefulWidget {

  const LowSodiumTabView({super.key});

  @override
  State<LowSodiumTabView> createState() => _LowSodiumTabViewState();
}

class _LowSodiumTabViewState extends State<LowSodiumTabView> {
  ...
  var isLiked = false;
    return StreamBuilder(
      ...
      stream: _recipeStorage.getLowSodiumRecipes(),
