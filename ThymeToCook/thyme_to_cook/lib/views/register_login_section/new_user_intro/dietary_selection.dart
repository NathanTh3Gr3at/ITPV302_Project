                    ...
                    children: [
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                            backgroundColor: isVeganSelected
                                ? backgroundColor
                                : Colors.white,
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              backgroundColor: isPaleoSelected
                                  ? backgroundColor
                                  : Colors.white,
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(30))),
                      ...
                      ElevatedButton(
                        onPressed: () {
                          ...
                          Provider.of<UserProvider>(context, listen: false)
                              .updateDiet("KETO_FRIENDLY");
                        },
                        style: ElevatedButton.styleFrom(
                            backgroundColor:
                                isKetoSelected ? backgroundColor : Colors.white,
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(30))),
                        child: const Text(
                          'Keto',
                  ...
                  child: Row(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                            backgroundColor: isLowCarbSelected
                                ? backgroundColor
                                : Colors.white,
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(30))),
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              backgroundColor: isVegetarianSelected
                                  ? backgroundColor
                                  : Colors.white,
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(30))),
                  ...
                  child: Row(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                            backgroundColor: isLowFatSelected
                                ? backgroundColor
                                : Colors.white,
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(30))),
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              backgroundColor: isKosherSelected
                                  ? backgroundColor
                                  : Colors.white,
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(30))),
