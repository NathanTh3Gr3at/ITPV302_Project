...
class _HomeGuestViewState extends State<HomeGuestView> with TickerProviderStateMixin{
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    Navigator.pushReplacement(
      context,
      PageRouteBuilder(
        pageBuilder: (context, animation1, animation2) =>  const MainNavigation(isLoggedIn: false),
                    ...
                    child: _recipes.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final imageUrl = recipe.identifier == "kaggle" ? recipe.imageSrc : recipe.imageUrl;
                            return SizedBox(
          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                content: const Text('Please log in to save recipes.'),
                actions: <Widget>[
                  TextButton(
                    onPressed: () {
